...
public class TravelMainModel {
    ...
    @SerializedName("Data")
    @Expose
    private List<TravelDetailModel> data = null;
    ...
    public List<TravelDetailModel> getData() {
        return data;
    }

    public void setData(List<TravelDetailModel> data) {
        this.data = data;
    }
