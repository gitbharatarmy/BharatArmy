...
public class MultiSportsSelectDialog extends AppCompatDialogFragment implements SearchView.OnQueryTextListener, View.OnClickListener {
    ...
    private TextView dialogTitle, dialogSubmit, dialogCancel,close_btn1;
    ...
    private ArrayList<ImageDetailModel> tempMainListOfAdapter = new ArrayList<>();
...
//        dialog.getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        close_btn1.setOnClickListener(this);
    ...
    private ArrayList<ImageDetailModel> setCheckedIDS(ArrayList<ImageDetailModel> multiselectdata, ArrayList<Integer> listOfIdsSelected) {
    ...
    private ArrayList<ImageDetailModel> filter(ArrayList<ImageDetailModel> models, String query) {
        query = query.toLowerCase();
        final ArrayList<ImageDetailModel> filteredModelList = new ArrayList<>();
        if (query.equals("") | query.isEmpty()) {
            filteredModelList.addAll(models);
            return filteredModelList;
        }

        for (ImageDetailModel model : models) {
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        ArrayList<ImageDetailModel> filteredlist = filter(mainListOfAdapter, newText);
