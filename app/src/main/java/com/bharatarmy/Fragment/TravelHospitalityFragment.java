...
import com.bharatarmy.databinding.FragmentTravelHospitalityBinding;

import java.util.ArrayList;
import java.util.List;

public class TravelHospitalityFragment extends Fragment {
    ...
    View rootView;
    FragmentTravelHospitalityBinding travelHospitalityBinding;
    Context mContext;
    public List<TravelDetailModel> ticketArray,hospitalityArray,transferArray;

    TravelTicketListAdapter travelTicketListAdapter;
    public TravelHospitalityFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static TravelHospitalityFragment newInstance(String param1, String param2) {
        TravelHospitalityFragment fragment = new TravelHospitalityFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        travelHospitalityBinding= DataBindingUtil.inflate(inflater, R.layout.fragment_travel_hospitality, container, false);

        rootView = travelHospitalityBinding.getRoot();
