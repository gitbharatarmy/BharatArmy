...
public class InquiryFilterListAdapter extends RecyclerView.Adapter<InquiryFilterListAdapter.MyViewHolder> {
    ...
    public InquiryFilterListAdapter(Context mContext, List<MoreDetailDataModel> moreDetailDataModelList, image_click image_click, MorestoryClick morestoryClick) {
    ...
    @Override
    public InquiryFilterListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new InquiryFilterListAdapter.MyViewHolder(inquiryListItemBinding);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(InquiryFilterListAdapter.MyViewHolder holder, int position) {
