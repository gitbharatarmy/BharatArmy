...
public class RelatedHospitalityDetailAdapter extends RecyclerView.Adapter<RelatedHospitalityDetailAdapter.MyItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final RelatedHospitalityDetailAdapter.MyItemViewHolder holder, int position) {
        ...
        Utils.setImageInImageView(detail.getTicket_hospitality_bannerImage(), holder.hospitalityRelatedHospitalityListItemBinding.travelHospitalityBannerImg, mContext);
        holder.hospitalityRelatedHospitalityListItemBinding.categoryNameTxt.setText(detail.getTicket_hospitality_namecategory());
        holder.hospitalityRelatedHospitalityListItemBinding.showPackageTourDescriptionTxt.setText(detail.getTicket_hospitality_desc());
