...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        defaultTabOneButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_fans);
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_flight);
        defaultTabThreeButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_event);
        defaultTabFourButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_ftp);
        defaultTabFiveButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_story);
